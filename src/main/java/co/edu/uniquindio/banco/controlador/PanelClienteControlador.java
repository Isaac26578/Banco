...
public class PanelClienteControlador implements Initializable {
    ...
    public void inicializarValores(){
        ...
        lblSaldo.setText(sesion.getUsuario().getNombre());
        resultado= banco.ConsultarNombre(sesion.getUsuario().getNumeroIdentificacion(), sesion.getUsuario().getContrasena());
        lblCuenta.setText(resultado);
    }
